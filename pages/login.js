								...
								<div className="my-10 text-gray-700 p-4">
										<div className='p-4'>
												...
												<div id='other' className='p-4'>
														<div className='p-4'>
																<button className="w-full h-12 px-6 text-black-700 transition-colors duration-150 bg-blue-200 rounded-lg focus:shadow-outline hover:bg-indigo-800 hover:text-slate-300" type='submit' onClick={() => signIn()}>Google ID로 로그인</button>
